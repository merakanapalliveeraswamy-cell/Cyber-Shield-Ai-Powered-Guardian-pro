export const en = {
  ...
  "chatbot.welcome": "Paste any suspicious message, link, or text to scan for threats.",
  "chatbot.placeholder": "Paste suspicious message or link...",
  "chatbot.title": "AI Safety Chatbot",
  "chatbot.alerts.phishing": "⚠️ Warning! This message may be a phishing attempt. Do not click suspicious links.",
  "chatbot.alerts.safe": "✅ This message appears safe.",
  "chatbot.alerts.harassment": "🚨 Potential harassment detected.",
  "chatbot.alerts.childWarning": "This message may not be safe. Please check with your parent.",
  "chatbot.alerts.upiScam": "⚠️ UPI Scam Alert! Do not share OTP or PIN.",
  "chatbot.alerts.fraudLink": "⚠️ Fraud Link Alert! This link may be malicious.",
  "chatbot.alerts.stranger": "⚠️ Stranger Contact Alert! Be cautious.",
  "chatbot.alerts.inappropriate": "⚠️ Inappropriate Content Alert!",
  "chatbot.alerts.lateNight": "⚠️ Late Night Activity Alert!",
} as const;
